...
public class VirtualServerController {
    ...
    @GetMapping(value = {"/", "/VirtualServers"})
    public String showList(@RequestParam(required = false) Integer activeMoreThanDays,
        ...
        model.addAttribute("OSType", OSType.values());
        // mozebi bez model.addAttribute("OSType", OSType.values());
    ...
    public String showAdd(Model model) {
       // model.addAttribute("virtualServer", new VirtualServer());
        model.addAttribute("OSType", OSType.values());
        model.addAttribute("users", userService.listAll());
        // or
