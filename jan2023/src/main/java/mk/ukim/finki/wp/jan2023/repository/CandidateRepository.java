...
public interface CandidateRepository extends JpaRepository<Candidate, Long> {
    ...
    List<Candidate> findAllByDateOfBirthBeforeAndGenderEquals(LocalDate dateOfBirth, Gender gender);

    List<Candidate> findAllByDateOfBirthBefore(LocalDate dateOfBirth);
